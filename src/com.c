...
void procesarUdp(void)
{
    			if((bufferRecepcion[0]=='$')&&(bufferRecepcion[1]=='P')&&(bufferRecepcion[2]=='I')&&(bufferRecepcion[3]=='N')&&(bufferRecepcion[4]=='G')&&(bufferRecepcion[5]=='#'))
				{
					...
					//from.sin_port = htons(9091);
					//m=sendto(sock, buffer2, strlen(buffer2),0,(const struct sockaddr *)&from, 30);
					//printf("PING %d ************************************************************ \n",n);


				}
                
                if((bufferRecepcion[0]=='$')&&(bufferRecepcion[1]=='A')&&(bufferRecepcion[2]=='P')&&(bufferRecepcion[3]=='A')&&(bufferRecepcion[4]=='G')&&(bufferRecepcion[5]=='A')&&(bufferRecepcion[6]=='R')&&(bufferRecepcion[7]=='#'))
				{
                ...
                if((bufferRecepcion[0]=='$')&&(bufferRecepcion[1]=='R')&&(bufferRecepcion[2]=='E')&&(bufferRecepcion[3]=='I')&&(bufferRecepcion[4]=='N')&&(bufferRecepcion[5]=='I')&&(bufferRecepcion[6]=='C')&&(bufferRecepcion[7]=='I')&&(bufferRecepcion[8]=='A')&&(bufferRecepcion[9]=='R')&&(bufferRecepcion[10]=='#'))
				{
                ...
                if((bufferRecepcion[0]=='$')&&(bufferRecepcion[1]=='H')&&(bufferRecepcion[2]=='O')&&(bufferRecepcion[3]=='N')&&(bufferRecepcion[4]=='#'))
				{
					bandera_reloj=1;
                ...
                if((bufferRecepcion[0]=='$')&&(bufferRecepcion[1]=='H')&&(bufferRecepcion[2]=='O')&&(bufferRecepcion[3]=='F')&&(bufferRecepcion[4]=='F')&&(bufferRecepcion[5]=='#'))
				{
					bandera_reloj=0;
                ...
                if((bufferRecepcion[0]=='$')&&(bufferRecepcion[1]=='C')&&(bufferRecepcion[2]=='O')&&(bufferRecepcion[3]=='N')&&(bufferRecepcion[4]=='#'))
				{
                ...
                if((bufferRecepcion[0]=='$')&&(bufferRecepcion[1]=='C')&&(bufferRecepcion[2]=='O')&&(bufferRecepcion[3]=='F')&&(bufferRecepcion[4]=='F')&&(bufferRecepcion[5]=='#'))
				{
